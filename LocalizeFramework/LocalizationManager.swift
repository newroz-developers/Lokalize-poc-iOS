...
@objcMembers class LocalizationManager : NSObject {
    private static var privateSharedInstance: LocalizationManager?
    static var sharedInstance: LocalizationManager {
        if privateSharedInstance == nil {
            privateSharedInstance = LocalizationManager()
        }
    ...
    lazy var bundlePath: URL = {
        ...
        let bundlePath = documents.appendingPathComponent(Localizable.BundleName, isDirectory: true)
        return bundlePath
    }()
